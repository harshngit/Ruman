...
const ServiceTwo = () => {
  return (
    <>
      <section className="service-block lg:mt-[0px] sm:mt-16  bg-[#2a77ffcf] p-5">
        <div className="container xl:flex items-center justify-center">
          <div className="xl:w-1/3 w-full flex flex-col gap-4 flex-shrink-0">
            ...
            <div className="body3 lg:text-left text-center  text-[#ccc]">Accounting and financial reporting are challenging tasks for any business or individual dealing high volume transactions. In addition, changes in regulations, taxation standards, and technology adaptations make it more complex, and companies struggle to get their numbers and reports done on time and accurately. </div>
            <div className='body3 lg:text-left text-center  text-[#ccc]'>
