                    ...
                    <div className="flex max-lg:flex-col max-lg:items-start gap-y-10 pb-10">
                        <div className="lg:w-1/4">
                            <div className="footer-company-infor flex flex-col justify-between gap-5">
                                ...
                                <div className="list-social flex items-center gap-2.5 style-one">
                                    <Link className="item rounded-full w-7 h-7 border-2 border-grey flex items-center justify-center flex-col" href="https://www.facebook.com/share/18HrDpYS4E/" aria-label="Share on Facebook"
                        ...
                        <div className="lg:w-1/4">
                            <div className="company-contact">
                                <div className="heading text-button-sm text-white">Official Information</div>
                                <div className="mt-3 flex items-center mb-6">
                                    ...
                                    <div className="text lg:ml-16 ml-5">
                                ...
                                <div className="locate mt-3 flex items-center">
                                    ...
                                    <div className="caption1 capitalize text-surface ml-2"> 301, Shantadeep CHS LTD.,Tejpal Scheme NO.2, Ville Parle (E), Mumbai-400057</div>
                                </div>
